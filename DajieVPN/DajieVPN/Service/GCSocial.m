...
+ (void)ShareToWechatSession:(NSString *)url
    ...
    [[UMSocialDataService defaultDataService]  postSNSWithTypes:@[UMShareToWechatSession] content:content.length > 200 ? [content substringWithRange:NSMakeRange(0, 200)] : content image:[UIImage imageNamed:IMAGEURL] location:nil urlResource:nil presentedController:nil completion:^(UMSocialResponseEntity *response){
